...
// //   // User must provide phone for regular users
// //   if (!phone) {
// //     throw new BadRequestError("Please provide phone number");
// //   }
...
// //   try {
// //     // Find user by phone
// //     const user = await User.findOne({ phone, role: { $in: ['customer', 'rider'] } });
...
// //       permissions: isSuper ? ['all'] : ['view'],
// //       status: 'active',
// //       phone: `admin-${username}` // Add a unique placeholder phone
// //     });
...
// //     // Get the user by role and ID
// //     const user = await User.findOne({ 
// //       _id: payload.id,
// //       role: isAdmin ? 'admin' : { $in: ['customer', 'rider'] }
// //     });
...
// // // Account deactivation for all user types
// // export const deactivateAccount = async (req, res) => {
// //   try {
// //     const user = await User.findById(req.user.id);
...
// // Account deactivation for users
// export const deactivateAccount = async (req, res) => {
//   try {
//     const user = await User.findById(req.user.id);
